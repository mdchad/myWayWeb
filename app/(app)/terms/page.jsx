function Terms() {
  return (
    <div className="p-16">
      ...
      <p>
        Pixelmind Studio is committed to ensuring that the app is as useful and
      ...
      <p>
        The My Way app stores and processes personal data that you have provided
        ...
        features and it could mean that the My Way app won’t work properly or at
        all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Pixelmind Studio
        ...
        can be Wi-Fi or provided by your mobile network provider, but Pixelmind
      ...
      <p>
        Along the same lines, Pixelmind Studio cannot always take responsibility
        ...
        avail the Service, Pixelmind Studio cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Pixelmind Studio’s responsibility for your use of the
        ...
        we can make it available to you. Pixelmind Studio accepts no liability
      ...
      <p>
        ...
        updates if you want to keep using the app. Pixelmind Studio does not
      ...
      <p>These terms and conditions are effective as of 2023-10-09</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at irsyad.muhd@gmail.com.
      </p>{" "}
      <p>
